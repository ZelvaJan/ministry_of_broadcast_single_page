            ...
            <div className='PressKit_root'>
                <div className='PressKit'>
                    <div className='PressKit_content'>
                        ...
                        <div className='PressKit_section'>
                            <div className='PressKit_box PressKit_content_wrapper'>
                                ...
                                <div className='flex_v just_center flex_1'>
                                    <p className='margin_small'>Factsheet</p>
                                    <p className='margin_small'>Story</p>
                                    <p className='margin_small'>Creative Direction</p>
                                    <p className='margin_small'>Logo & Icon</p>
                                    <p className='margin_small'>Trailer</p>
                                    <p className='margin_small'>Images</p>
                                    <p className='margin_small'>Online Activity</p>
                                    <p className='margin_small'>Team</p>
                                    <p className='margin_small'>Award & Recognition</p>
                                    <p className='margin_small'>Selected Articles</p>
                                </div>
                            </div>
                        ...
                        <div className='PressKit_section'>
                            <div className='PressKit_box PressKit_creativeDir'>
                        ...
                        <div className='PressKit_section'>
                            <div className='PressKit_section_column flex_1'>
                                <div className='PressKit_box flex_1 flex_v'>
                                    <h3>TRAILER</h3>
                        ...
                        <div className='PressKit_section'>
                            <div className='PressKit_box PressKit_team '>
                                <h3>THE TEAM</h3>
                                <h4>Core Team:</h4>
