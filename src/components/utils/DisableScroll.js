...
class DisableScroll {
    ...
    on(element, options) {
        ...
        if (disableWheel) {
            ...
            document.addEventListener('touchstart', this.handleWheel);
            document.addEventListener('touchend', this.handleWheel);
        }
    ...
    off() {
        ...
        document.removeEventListener('touchstart', this.handleWheel);
        document.removeEventListener('touchmove', this.handleWheel);
        document.removeEventListener('touchend', this.handleWheel);
